...
const Nav = () => {
    return (
        <div className="pt-[3.4rem] bg-[#C2EFD4] lg:px-[10%] flex flex-col lg:flex-row justify-between items-center">
            <h1 className="text-[#224F34] robo text-[2.5rem] font-bold">Rivo</h1>
            <div className="flex gap-[3.5rem]">
                <a className="text-[#224F34] popin text-xs lg:text-[1.375rem] font-medium uppercase" href="">Home</a>
                <a className="text-[#224F34] popin text-xs lg:text-[1.375rem] font-medium uppercase" href="">Shop</a>
                <a className="text-[#224F34] popin text-xs lg:text-[1.375rem] font-medium uppercase" href="">Features</a>
                <a className="text-[#224F34] popin text-xs lg:text-[1.375rem] font-medium uppercase" href="">Contact</a>
            </div>
            <div className="flex gap-[3.5rem] items-center relative mt-6 lg:mt-0">
                <div>
                    ...
                    <div className="absolute top-6 left-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                            <g filter="url(#filter0_d_1_268)">
                                <circle cx="13" cy="12" r="5" fill="#10FF70" />
                            </g>
                            <defs>
                                <filter id="filter0_d_1_268" x="0" y="0" width="28" height="28" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                ...
                <button className="text-[#224F34] popin text-xl font-medium w-[8.875rem] h-[3.25rem] rounded-sm border-[#224F34] border-2 hover:bg-green-400 hover:text-white hover:font-bold">LOGIN</button>
            </div>
        </div>
    );
};
